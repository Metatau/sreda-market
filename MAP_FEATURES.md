...
- **Полигональный поиск**: Рисование произвольных областей для поиска
- **Прямоугольная область**: Быстрое выделение прямоугольных зон
- **Расчет площади**: Автоматическое вычисление площади выбранной области
- **Интерактивное редактирование**: Изменение формы нарисованных областей
