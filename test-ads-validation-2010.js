...
async function testAdsValidation() {
  ...
  console.log('• Тип: новостройки, дома и квартиры');
  console.log('• Год постройки: не позднее 2010 года');
  console.log('• Исключения: комнаты, участки, гаражи, коммерческая недвижимость');
